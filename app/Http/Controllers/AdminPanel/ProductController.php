...
class ProductController extends Controller
{
    ...
    public function add_custom_made()
    {
        ...
        $product_color = ProductColor::where('is_delete', 0)->orderBy('created_at', 'desc')->get();
        // echo json_encode($product_color);die;
        return view('AdminPanel.Product.product_custom_made')->with('category', $category)
            ->with('size_option', $size_option)
            ->with('sub_category', $sub_category)
            ->with('stores', $stores)
            ->with('product_color', $product_color);
    ...
    public function add_ready_made()
    {
        ...
        $product_color = ProductColor::where('is_delete', 0)->orderBy('created_at', 'desc')->get();
        // echo json_encode($product_color);die;
        return view('AdminPanel.Product.product_ready_made')->with('category', $category)
            ->with('size_option', $size_option)
            ->with('sub_category', $sub_category)
            ->with('stores', $stores)
            ->with('product_color', $product_color);
    ...
    public function edit_product(Request $request, $id)
    {
        ...
        if ($product) {
            ...
            if ($product->product_type == 'custom_made') {
                ...
                return view('AdminPanel.Product.edit_custom_product')
            ...
            if ($product->product_type == 'ready_made') {
                ...
                return view('AdminPanel.Product.edit_ready_made_product')
                    ->with('product', $product)
                    ->with('product_color', $product_color)
                    ->with('category', $category)
                    ->with('sub_category', $sub_category)
            ...
            if ($product->product_type == 'service') {
                ...
                return view('AdminPanel.Product.edit_service_made')
                    ->with('product', $product)
                    // ->with('product_color', $product_color)
                    ->with('category', $category)
                    ->with('sub_category', $sub_category)
