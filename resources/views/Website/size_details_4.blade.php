                                ...
                                <div class="card-body form-sizeing sizeing">
                                    <div class="box-table border mb-4">
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" placeholder='Please Enter The Size' autofocus
                                                    data-size-name="neck-rotation" data-style='right: -9%;top: 18%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-neck-rotation.png') }}">
                                            </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" placeholder='Please Enter The Size'
                                                    data-size-name="chest-rotation" data-style='top: 29.5%;right: -19%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-chest-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" placeholder='Please Enter The Size'
                                                    data-size-name="waist-rotation" data-style='top:37%;right:-17%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-waist-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class=" p-3 w-50">
                                                <input type="text" placeholder='Please Enter The Size'
                                                    data-size-name="hip-rotation" data-style='top:46%;right:-28%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-hip-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                ...
                                <div class="card-body form-sizeing sizeing">
                                    <div class="box-table border mb-4">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" placeholder='Please Enter The Size' autofocus
                                                    data-size-name="size-4-wrist-rotation"
                                                    data-style='right: -22%;top:20%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-wrist-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    ...
                                                    data-style='right:-30%;top:28%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-Shoulder-joint-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="upper-arm-rotation" data-style='right:-37%;top: 35%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-upper-arm-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="elbow-rotation" data-style='right:-42%;top:47%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-1-elbow-rotation.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                ...
                                <div class="card-body form-sizeing sizeing">
                                    <div class="box-table border mb-4">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="shoulder-width" data-style='right:-17%;top: 18%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-3-shoulder-width.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="chest-width" data-style='right:-20%;top:24%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-3-chest-width.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="size-4-chest-point-height"
                                                    data-style='right:-11%;top: 26%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-3-chest-point-height.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                ...
                                <div class="card-body form-sizeing sizeing">
                                    <div class="box-table border mb-4">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="size-4-bra-length" data-style='right:-11%;top: 26%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-4-bra-length.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="total-length" data-style='right:-35%;top: 37%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-4-total-length.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="size-4-skirt-length" data-style='right:-11% ;top: 50%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/size-4-skirt-length.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                ...
                                <div class="card-body form-sizeing sizeing">
                                    ...
                                    <div class="box-table border mb-4">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="neck" data-style='right: -13%;top:19%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/backsize-neck.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="shoulder" data-style='right:-26%;top:22%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/backsize-shoulder.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border-bottom p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="back-view" data-style='right:-23%;top:26%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/backsize-back-view.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="p-3 w-50">
                                                <input type="text" autofocus placeholder='Please Enter The Size'
                                                    data-size-name="size-4-back-length" data-style='right:-3%;top:30%'
                                                    data-img-url="{{ asset('assets/images/sizing/img-size-girl/backsize-back-length.png') }}">
                                            </div>
                                            <div class="check-done"></div>
                                        </div>
