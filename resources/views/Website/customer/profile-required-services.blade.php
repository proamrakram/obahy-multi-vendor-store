...
@section('content')
    ...
    <div class="tabs-link mb-4">
        <div class="container">
            <div class="tabs-link-btn bg-gray d-flex">
                <a href="{{ route('customer.profile-orders') }}" class='btn btn-outline-primary rounded-0'> Orders (Products)
                </a>
                <a href="{{ route('customer.profile-required-services') }}" class='btn btn-primary rounded-0'> Required
                    Services </a>
            </div>
        </div>
    </div>
    ...
    <div class="products-ordering required-service">
        <div class="container">
                ...
                <div class="d-md-flex d-block justify-content-between align-items-center">
                    <div class="step-content-product-box d-flex align-items-center mb-2 mb-md-0">
                        ...
                        <div class="cotent pl-2">
                            ...
                            <p class="m-0">
                                <a href="#" class='text-gray font-sm'> More Detaile For Service </a>
                            </p>
                        </div>
                    </div>

                    <div class="appearance-expert">
                        <span class="d-block"> Appearance Expert </span>
                        <span class='font-sm'> <a class='text-gray' href=""> Here Name </a> </span>
                    </div>

                    <div class="status">
                        <span class='d-block'> Status </span>
                        <span class='text-blue font-sm'>Underway</span>
                    </div>
                    ...
                    <div class="tools-setting">
                        <a href="#" class="pr-2 pl-2 text-decoration-none"> <i class="far fa-edit"></i> </a>
                        <a href="#" class="pr-2 pl-2 text-decoration-none"> <i class="fas fa-trash-alt"></i> </a>
                    </div>
                </div>
            </div>
            <!-- End Item -->
            ...
            <div class="step-content-products p-2 rounded border mb-3">
                <div class="d-md-flex d-block justify-content-between align-items-center">
                    ...
                    <div class="tools-setting">
                        <a data-toggle="modal" href="#EditDataUser" class="pr-2 pl-2 text-decoration-none"><i class="far fa-edit"></i></a>
                        <a href="#" class="pr-2 pl-2 text-decoration-none"> <i class="fas fa-trash-alt"></i> </a>
                    </div>
                </div>
            </div>
