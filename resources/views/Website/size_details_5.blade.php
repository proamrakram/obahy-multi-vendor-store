    ...
    <div class="size-details product-tabs pt-3">
        <div class="container">
            ...
            <div class="row pt-md-3 pt-0 ">
                <div class="col-lg-6">
                    <div class="desc-tab">
                        <p class="">اتبع الطريقة الصحيحة لأخد المقاسات</p>
                        <p class="">
                            لقياس ( دوران الجسم ) نقوم بلف شريط المتر حول محيط الجزء المطلوب مع مراعاة الاتساع المناسب
                            للبدلة.
                        </p>
                        <p>
                            لقياس ( الطول والعرض ) نقوم بوضع شريط المتر بشكل مستقيم مع مراعاة نقاط البداية والنهاية.
                        </p>
                        <p>
                            <b>ملاحظة: </b>
                            لقياس اكثر دقة إرتداء بدلة مناسبة وتطبيق المقاسات المطلوبة عليها.
                        </p>
                    </div>
