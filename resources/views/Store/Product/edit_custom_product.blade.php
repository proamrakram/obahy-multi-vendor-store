                                ...
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <input type="text" class="form-control" id="product_name_ar"
                                                            name="product_name_ar" value="{{ $product->product_name_ar }}"
                                                            placeholder="اسم المنتج بالعربية">
                                                    </div>
                                                    <div class="col-6">
                                                        <input type="text" class="form-control" id="product_name_en"
                                                            name="product_name_en" value="{{ $product->product_name_en }}"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="text" class="form-control" id="product_serial_number"
                                                    value="{{ $product->product_serial_number }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            ...
                                            <label for="product_category" class="col-3 col-form-label"> تصنيف المنتج
                                                <span class='text-danger'> * </span>
                                            </label>

                                            <div class="col-9">

                                                <select name="product_category" id="product_category" class='form-control form-select'>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label for="product_category" class="col-3 col-form-label"> تصنيف المنتج الفرعي
                                                <span class='text-danger'> * </span> </label>
                                            <div class="col-9">
                                                <select name="product_category_sub" id="product_category"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="text" class="form-control"
                                                    value="{{ $product->product_vat }}" id="product_vat" name="product_vat"
                                                    placeholder="الضريبة">
                                            </div>
                                        </div>
                                    </div> <!-- / End tax Product -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="text" class="form-control" id="product_price_after_vat"
                                                    name="product_price_after_vat"
                                                    value="{{ $product->product_price_after_vat }}"
                                                    placeholder="السعر بعد الضريبة ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-9">
                                                <select name="in_stock" id="in_stock" class='form-control form-select'>
                                                    <option @if ($product->in_stock == 1) selected @endif
                                                        value="1"> نعم </option>
                                                    <option @if ($product->in_stock == 0) selected @endif
                                                        value="0"> لا </option>
                                                </select>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="mb-0">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            @if ($item['is_checked'] == 'true') checked @endif
                                                                            name="product_colors[]"
                                                                            value="{{ $item['id'] }}" id="">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="custom_made_description" name="custom_made_description"
                                                            placeholder="وصف المنتج بالعربية ">{{ $custom->custom_made_description ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="custom_made_description_en" name="custom_made_description_en"
                                                            placeholder="وصف المنتج بالانجليزية ">{{ $custom->custom_made_description_en ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-7">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="fabric_options" name="fabric_options" placeholder="خيارات الأقمشة بالعربية ">{{ $custom->fabric_options ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="fabric_options_en" name="fabric_options_en"
                                                            placeholder="خيارات الأقمشة بالانجليزية ">{{ $custom->fabric_options_en ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 align-self-end">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="embroidery_options" name="embroidery_options"
                                                            placeholder="خيارات التطريز بالعربية ">{{ $custom->embroidery_options ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="embroidery_options_en" name="embroidery_options_en"
                                                            placeholder="خيارات التطريز بالانجليزية ">{{ $custom->embroidery_options_en ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 align-self-end">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="accessories_options" name="accessories_options"
                                                            placeholder="خيارات الاكسسوارات  بالعربية">{{ $custom->accessories_options ?? '' }}</textarea>
                                                    </div>
                                                    <div class="col-6">
                                                        <textarea class="form-control" id="accessories_options_en" name="accessories_options_en"
                                                            placeholder="خيارات الاكسسوارات  بالانجليزية"><{{ $custom->accessories_options_en ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 align-self-end">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-8">
                                                <input type="text" class="form-control" id="implementation_period"
                                                    ...
                                                    value="{{ $custom->implementation_period ?? '' }}"
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-9">
                                                            <textarea class="form-control mb-2" id="other_size_notes" name="other_size_notes"
                                                                placeholder="إضافة ملاحظة بالعربية ">{{ $custom->other_size_notes ?? '' }}</textarea>
                                                            <textarea class="form-control mb-2" id="other_size_notes_en" name="other_size_notes_en"
                                                                placeholder="إضافة ملاحظة بالانجليزية ">{{ $custom->other_size_notes_en ?? '' }}</textarea>
                                                        </div>
                                                    </div>
                                                </div> <!-- // Add Notes -->
                                            </div>
                                    ...
                                    <hr class='mt-3'>
                                    <div class="col-md-4">
                                        <button class='btn btn-dark px-4 mx-4 py-2' type="submit"
                                            id="add_product_sbtn">تعديل المنتج </button>
                                    </div>
                                </div>
