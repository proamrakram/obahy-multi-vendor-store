                                        ...
                                        <td class="text-end p-3">
                                            <div class="tools-options d-flex justify-content-center">
                                                @if (auth()->user()->can('store-roles-edit'))
                                                    <a href="{{ route('store.roles.edit', ['id' => $role->id]) }}"> <i
                                                            class="uil uil-edit"></i> </a>
                                                @endif
                                                @if (auth()->user()->can('store-roles-delete'))
                                                    <a href="{{ route('store.roles.delete', ['id' => $role->id]) }}"
                                                        onclick="return confirm('هل انت متأكد من حذف ({{ $role->name }})?')">
