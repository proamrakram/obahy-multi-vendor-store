    ...
    <div class="layout-specing">
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-3  bg-soft-dark   rounded-top border-bottom heading-with-shape">
                ...
                <div class="btns">
                    <a href="javascript:void(0)" class="btn btn-dark"> @lang('adminPanel.add-banner')</a>
                </div>
            </div>
            <form method="post" action="{{ route('store.advertisments.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="p-4">
