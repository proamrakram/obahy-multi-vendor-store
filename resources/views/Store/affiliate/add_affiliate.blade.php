        ...
        <div class="layout-specing">
            <div class="bg-white mt-3">
                ...
                <div class="p-4">
                    ...
                    <!-- Start Form -->
                    <form action="{{ route('affiliate.store_affiliate') }}" method="POST">
                        @csrf
                        <h5> بيانات المسوق </h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <div class="row">
                                                <div class="col"><input name="name_ar" type="text"
                                                        class="form-control" id="Marketer'sName" value="{{ old('name') }}"
                                                        placeholder="اسم المسوق هنا بالعربية"></div>
                                                <div class="col"><input type="text" name="name"
                                                        class="form-control   @error('name') is-invalid @enderror"
                                                        id="Marketer'sName" value="{{ old('name') }}"
                                                        placeholder="اسم المسوق هنا  بالانجليزية">
                                                    @error('name')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <input type="text" name="phone_number"
                                                ...
                                                id="phone_number" value="{{ old('phone_number') }}" placeholder="0123456789 ">
                                            @error('phone_number')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-9">
                                            <select onchange="getval(this);" name="country_id" id="country"
                                                ...
                                                @foreach ($countries as $con)
                                                    <option @if (old('country_id') == $con->id)
                                                        selected
                                                    @endif value="{{ $con->id }}">{{ $con->country_name_ar }}</option>
                                                @endforeach
                                            ...
                                            <select name="city_id" id="city"
                                               ...
                                               @endif >
                                                ...
                                                @if($c->id == old('city_id')){
                                                    ...
                                                    <option value="{{ old('city_id') }}">{{ $c->city_name_ar }} </option>
                                                }
                                                @endif
                            ...
                            <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <select name="link_type" id="link_type" onchange="funlink(this);"
                                                ...
                                                <option @if (old('link_type') == "product")
                                                    selected
                                                @endif value="product"> منتج </option>
                                                <option @if (old('link_type') == "store")
                                                    selected
                                ...
                                <div class="col-md-10">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <input type="text"  id="CopyURL" disabled placeholder="URL" value="{{ old('link') }}"
                                                class="form-control @error('link') is-invalid @enderror" >
                                            <input type="hidden" name="link" id="CopyURL1"  value="{{ old('link') }}"
                                                class="form-control " >
                                            @error('link')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <select name="affiliate_type" id="Commissiontype"
                                                ...
                                                <option @if (old('affiliate_type') == 'fixed')
                                            selected
                                                @endif value="fixed"> مبلغ ثابت </option>
                                                <option @if (old('affiliate_type') == 'ratro')
                                                selected
                                ...
                                <div class="col-md-5">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <div class="form-text">
                                                <input type="text" name="affiliate_value" value="{{ old('affiliate_value') }}" class="form-control  @error('affiliate_value') is-invalid @enderror"
                                                ...
                                                <span class='text'>
                                                    ...
                                                    <select class='form-control form-select  @error('affiliate_currency') is-invalid @enderror' id="currency"
                                                        ...
                                                        @foreach ($currency as $cur)
                                                            <option @if (old('affiliate_currency') == $cur->id)
                                                                selected
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-9">
                                            <select name="apply_affiliate" id="CommissionApplication"
                                                ...
                                                <option value="1"> علي اول منتج يباع </option>
                                                <option value="2"> علي اول منتج يباع </option>
                                            </select>
        ...
        function funlink(sel){
            ...
            if(sel.value == 'product'){
                ...
                success: function(resp) {
                    ...
                    $("#product")
                    .append(
                        '<div class="row mb-3" id="product_div"><label for="ActiveDate" class="col-3 col-form-label">  المنتجات المتاحه <span class="text-danger"> * </span> </label><div class="col-9" id="products"> <select  id="product_make_link" onchange="funproduct(this);"class="form-control form-select is-invalid"><option > اختر المنتج المراد اضافته</option></select></div> </div>'
                        );
                    // $("#code").append('<option value=' + value.code + '>' +value.language_name+' : '+value.code + '</option>');
                    // $('#city')
                    //     .find('option')
