    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                ...
                <div class="btns">
                    <a href="{{route('store.sales.index')}}" class="btn btn-dark"> @lang('adminPanel.total-sales') </a>
                    <a href="{{route('store.sales.best-sales')}}" class="btn btn-outline-dark "> @lang('adminPanel.best-sales') </a>
                    <a href="{{route('store.sales.lowest-selling')}}" class="btn btn-outline-dark">@lang('adminPanel.lowest-sales') </a>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        function filter($date, $product_id, $customer_id, $country_id) {
            ...
            $.ajax({
                url: "/store/sales/search?date=" + $date + "&product_id=" + $product_id + "&customer_id=" + $customer_id +
