        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                ...
                <div class="btns">
                    ...
                    <a href="{{route('store.sales.best-sales')}}" class="btn btn-dark "> @lang('adminPanel.best-sales')  </a>
...
<script>
    $(document).ready(function() {
        function filter($date, $product_id, $customer_id, $country_id) {
            ...
            $.ajax({
                url: "/store/best-sales/search?date=" + $date + "&product_id=" + $product_id + "&customer_id=" + $customer_id +
