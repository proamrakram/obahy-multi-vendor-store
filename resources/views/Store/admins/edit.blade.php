        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="update_name" required id="userName" value="{{$admin->name}}" class="form-control mb-2 @error('update_name') is-invalid @enderror" placeholder="@lang('adminPanel.name-ar')">
                        @error('update_name')
            ...
            <div class="col-md-6">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-8"> <input name="update_phone_number" required value="{{$admin->phone_number}}" type="text" id="userphone_number" class="form-control @error('update_phone_number') is-invalid @enderror" placeholder="@lang('adminPanel.please-enter-11-numbers')">
            ...
            <div class="col-md-6">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-8">
                        <input type="email" name="update_email" required value="{{$admin->email}}" id="userName" class="form-control mb-2 @error('update_email') is-invalid @enderror" placeholder="@lang('adminPanel.email')">
                        @error('update_email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-md-6">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-8">
                        <select name="update_gender" required id="" class="form-control form-select @error('update_gender') is-invalid @enderror">
            ...
            <div class="col-md-6">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-8">
                        <select name="update_role" id="" required class="form-control form-select @error('update_role') is-invalid @enderror">
