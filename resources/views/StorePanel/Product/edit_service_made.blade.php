                ...
                <div class="p-4">
                    <div class="tab-obahy">
                        <ul class='nav border d-inline-block'>
                            <li class='active'><a href="{{ route('products.add.ready_made') }}"> منتج جاهز </a></li>
                    ...
                    <!-- Start Form -->
                    <form action="{{ route('products.update.update_product', $product->id) }}" method="POST"
                        id="add_product">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label for="product_category" class="col-3 col-form-label"> تصنيف المنتج <span
                                                    class='text-danger'> * </span> </label>
                                            <div class="col-9">
                                                <select name="product_sub_category" id=""
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="number" class="form-control" id="product_vat"
                                                    name="product_vat"  onchange="funcount(this);" value="{{ $product->product_vat }}"
                                                    placeholder="الضريبة">
                                            </div>
                                        </div>
                                    </div> <!-- / End tax Product -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-9">
                                                <input type="number" class="form-control" id="product_price"
                                                    name="product_price" onchange="funcount(this);" value="{{ $product->product_price }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="row mb-3">
                                            <label for="product_price_after_vat" class="col-3 col-form-label"> السعر بعد
                                                الضريبة </label>
                                            <div class="col-9">
                                                <input type="number" class="form-control" id="product_price_after_vat"
                                                    disabled
                                                    value="{{ $product->product_price_after_vat }}"
                                                    placeholder="السعر بعد الضريبة ">
                                                <input type="hidden" class="form-control" id="product_price_after_vat_hidden"
