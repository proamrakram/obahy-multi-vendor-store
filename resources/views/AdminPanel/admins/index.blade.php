    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4"> @lang('adminPanel.admin-settings') </h6>
                <div class="btns">
                                ...
                                <td class="text-end p-3">
                                    <div class="tools-options d-flex justify-content-center">
                                        <div class="form-check form-switch p-0 pt-1">
                                            ...
                                            <input class="form-check-input" type="checkbox" onclick="window.location='{{ route("admin.admins.changeStatus",["id"=>$admin->id]) }}'" id="flexSwitchCheckChecked" @if($admin->user_status == 'active') checked="" @endif>
                                        ...
                                        <a href="{{route('admin.admins.delete',['id'=>$admin->id])}}" onclick="return confirm('هل انت متأكد من حذف ({{$role->name}})?')"> <i class="uil uil-trash-alt"></i> </a>
                                    @endif
                                    </div>
                                </td>
                            </tr>
...
<script>
    ...
    var KTDatatablesExample = function() {
        ...
        // Hook export buttons
        var exportButtons = () => {
            const documentTitle = 'موظفي المنصة';
