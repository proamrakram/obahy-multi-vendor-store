...
<div class="container-fluid">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4">@lang('adminPanel.add-subscriber') </h6>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="text" value="{{ old('store_name_ar') }}" name="store_name_ar" class="form-control @error('store_name_ar') is-invalid @enderror" id="NameAr" placeholder="@lang('adminPanel.name-ar')">
                                        ...
                                        <div class="col-6">
                                             <input type="text" value="{{ old('store_name_en') }}" name="store_name_en" class="form-control col-6   @error('store_name_en') is-invalid @enderror" id="NameEn" placeholder="@lang('adminPanel.name-en')">
                                             @error('store_name_en')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="text"  value="{{ old('phone_number') }}" name="phone_number" class="form-control   @error('phone_number') is-invalid @enderror " id="Phone" placeholder="@lang('adminPanel.mobile-no')">
                                    @error('phone_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                   ...
                                   @foreach($admins as $admin)
                                                        <option value="{{$admin->id}}" @if(old('store_admin')==$admin->id )selected @endif>{{$admin->name}} </option>
                                                        @endforeach
                                   </select>
                                   @error('store_admin')
                                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="date"  value="{{ old('subscription_start_date') }}" name="subscription_start_date" class="form-control   @error('subscription_start_date') is-invalid @enderror" id="Phone" placeholder="@lang('adminPanel.subscription-start-date')">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <input type="text"  value="{{ old('store_domain') }}" name="store_domain" class="form-control   @error('store_domain') is-invalid @enderror" id="Date" placeholder="@lang('adminPanel.domain-name')">
                                    @error('store_domain')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <textarea type="text" name="store_description_ar"
                                            ...
                                            placeholder="@lang('adminPanel.store-description-ar')">{{ old('store_description_ar') }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <textarea type="text" name="store_description_en"
                                            ...
                                            placeholder="@lang('adminPanel.store-description-en')">{{ old('store_description_en') }}</textarea>
                        ...
                        <div class="row algin-items-center">
                            ...
                            <div class="col-md-3">
                                <div class="box-backage">
                                    <input type="radio" value="{{$package->id}}" name='subscription_package_id'>
                                    <label for="">
                            ...
                            <div class="row">
                                ...
                                <select name="payment_type_id" id="" class="form-select form-control   @error('payment_type_id') is-invalid @enderror">
                                    ...
                                    @foreach($payment_types as $type) 
                                     <option value="{{$type->id}}" @if(old('payment_type_id')==$type->id )selected @endif>{{$type->getName()}} </option>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-10">
                                    <div class="form-check form-switch p-0 pt-1">
                                        <input name="store_status" class="form-check-input   @error('store_status') is-invalid @enderror" type="checkbox" id="flexSwitchCheckChecked" checked="">
                                        @error('store_status')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
