                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" value="{{$role->name}}" name="role_name" class="form-control  @error('role_name') is-invalid @enderror" id="rolesName" placeholder="@lang('adminPanel.role-name') ">
                                    @error('role_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
