    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4">@lang('adminPanel.countries')</h6>
                <div class="btns">
                @if(auth()->user()->can('countries-create'))
                    <a href="{{route('admin.countries.create')}}"  class="btn btn-dark">@lang('adminPanel.add-country')</a>
                @endif
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-center table-hover bg-white mb-0" id="kt_datatable_teachers">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">@lang('adminPanel.country-name')</th>
