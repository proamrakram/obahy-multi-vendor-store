    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4">@lang('adminPanel.edit-comment')</h6>
            </div>

            <div class="p-4">
                <form method="post" action="{{ route('admin.products-comments.update',['id'=>$comment->id]) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <select name="product_id" id="" class="form-control form-select @error('product_id') is-invalid @enderror">
                                        ...
                                        <option value="{{$product->id}}"  @if($comment->product_id == $product->id) selected @endif>{{$product->getName()}} </option>
                                        @endforeach
                                    </select>
                                     @error('product_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <select class="example-fontawesome"  name="stars" id="" class="form-control form-select @error('stars') is-invalid @enderror">
                                        ...
                                        <option  value="{{$rate}}" @if($comment->stars == $rate) selected @endif>{{$rate}}</option>
                                        @endfor
                                        </select>
                                         @error('stars')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <textarea name="comment" class="form-control  @error('comment') is-invalid @enderror" id="rolesName" placeholder=" @lang('adminPanel.comment') "> {{$comment->comment}}</textarea>
                                    @error('comment')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
