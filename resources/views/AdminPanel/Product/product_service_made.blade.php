                ...
                <div class="p-4">
                    <div class="tab-obahy">
                        <ul class='nav border d-inline-block'>
                            <li><a href="{{ route('admin.products.add.ready_made') }}"> منتج جاهز </a></li>
                            <li><a href="{{ route('admin.products.add.custom_made') }}"> تصميم خاص </a></li>
                            <li class='active'><a href="{{ route('admin.products.add.service_made') }}"> منتج خدمة </a></li>
                        </ul>
                    </div> <!-- / end tab-->
                    <hr>

                    <!-- Start Form -->
                    <form action="{{ route('admin.products.add.add_product') }}" method="POST" id="add_product">
                        @csrf
