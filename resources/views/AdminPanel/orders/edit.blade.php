...
<div class="container-fluid">
    <div class="layout-specing">
        ...
        <div class="d-flex justify-content-between p-3 mb-3  bg-white   rounded-top border-bottom heading-with-shape">
            <h6 class="fw-bold mb-0 h4"> @lang('adminPanel.edit-order')</h6>
        </div>
                ...
                <div class="p-4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-6"><input type="date" value="{{date('Y-m-d',strtotime($order->created_at))}}" name="order_date" class="date form-control @error('order_date') is-invalid @enderror">
                                ...
                                <div class="col-6"><input type="time" value="{{date('H:i',strtotime($order->created_at))}}" name="order_time" class="date form-control @error('order_time') is-invalid @enderror">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="status" id="" class="form-control  @error('status') is-invalid @enderror">
                                <option value="awaiting_payment" @if($order->status == 'awaiting_payment')selected @endif> @lang('adminPanel.awaiting-payment')</option>
                                <option value="underway" @if($order->status == 'underway')selected @endif> @lang('adminPanel.underway')</option>
                                <option value="done" @if($order->status == 'done')selected @endif> @lang('adminPanel.done')</option>
                                <option value="delivery_in_progress" @if($order->status == 'delivery_in_progress')selected @endif> @lang('adminPanel.delivery-in-progress')</option>
                                <option value="delivered" @if($order->status == 'delivered')selected @endif> @lang('adminPanel.delivered')</option>
                                <option value="reference" @if($order->status == 'reference')selected @endif> @lang('adminPanel.reference')</option>
                                <option value="canceled" @if($order->status == 'canceled')selected @endif> @lang('adminPanel.canceled')</option>
                            </select>
                            @error('status')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="bg-white mb-3">
                        ...
                        <div class="content p-3">
                            ...
                            <select name="customer_id" id="" class="form-control  @error('customer_id') is-invalid @enderror">
                                ...
                                <option value="{{$customer->id}}" @if($customer->id == $order->user_id) selected @endif> {{$customer->name}}</option>
                                @endforeach
                            </select>
                            @error('customer_id')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="content p-3">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input name="shipping_price" value="{{$order->shipping_price}}" type="text" class="form-control  @error('shipping_price') is-invalid @enderror">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select name="payment_method_id" id="" class="form-control  @error('payment_method_id') is-invalid @enderror">
                                        ...
                                        <option value="{{$p->id}}" @if($order->payment_method_id == $p->id)selected @endif> {{$p->getName()}} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="repeater">
                                ...
                                @foreach($order->products as $order_product)
                                    <div class="row mb-2 g-2 align-items-center" data-repeater-item>
                                        <div class="col-md-6">
                                            <input name="order_product_id" type="hidden" class="form-control" value="{{$order_product->id}}">
                                            ...
                                            <select name="id" id="" class="form-control form-select select2 @error('product.id') is-invalid @enderror">
                                                ...
                                                <option value="{{$product->id}}" @if($product->id == $order_product->product_id) selected @endif> {{$product->getName()}} </option>
                                                @endforeach
                                            </select>
                                            @error('product.'.$i.'.id')
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-3">
                                            <input name="amount" type="text" value="{{$order_product->amount}}" placeholder="@lang('adminPanel.amount')" class="form-control @error('product.amount') is-invalid @enderror">
