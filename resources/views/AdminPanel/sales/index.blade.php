        ...
        <div class="layout-specing">
            ...
            <div class="bg-white ">
                <div class="d-flex justify-content-center p-4  bg-white   rounded-top border-bottom  ">
                     <div class="btns">
                        <a href="{{route('admin.sales.index')}}"  class="btn btn-dark">@lang('adminPanel.total-sales')  </a>
...
$.ajax({
    url: "/admin/sales/search?date="+$date+"&store_name="+$store_name+"&package_id="+$package_id+
