            ...
            <div class="bg-white ">
                <div class="d-flex justify-content-center p-4  bg-white   rounded-top border-bottom  ">
                     ...
                     <a href="{{route('admin.sales.index')}}"  class="btn btn-outline-dark">@lang('adminPanel.total-sales')  </a>
                        <a href="{{route('admin.sales.best-sales')}}" class="btn btn-dark ">@lang('adminPanel.best-sales')  </a>
                        <a href="{{route('admin.sales.lowest-selling')}}" class="btn btn-outline-dark">@lang('adminPanel.lowest-sales')  </a>
                   </div>
                </div>
...
$.ajax({
    url: "/admin/best-sales/search?date="+$date+"&store_name="+$store_name+"&package_id="+$package_id+
