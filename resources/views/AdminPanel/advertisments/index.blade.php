    ...
    <div class="layout-specing">
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-3  bg-soft-dark   rounded-top border-bottom heading-with-shape">
                ...
                <div class="btns">
                @if(auth()->user()->can('advertisments-create'))
                    <a href="{{route('admin.advertisments.create')}}" class="btn btn-dark">@lang('adminPanel.add-banner') </a>
                @endif
                </div>
            </div>
            ...
            <div class="p-4">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="box-banners d-block mb-3" style="
                            ...
                            <div class="d-flex justify-content-between pt-3">
                                ...
                                <div>
                                    <div class="tools-options d-flex justify-content-center">
                                        ...
                                        @if(auth()->user()->can('advertisments-edit'))
                                        <a href="{{route('admin.advertisments.edit',['id'=>$ads->id])}}"> <i class="uil uil-edit"></i> </a>
                                        @endif
                                        @if(auth()->user()->can('advertisments-delete'))
