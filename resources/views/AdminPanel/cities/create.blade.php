    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4"> @lang('adminPanel.add-city') </h6>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="city_name_en" class="form-control  @error('city_name_en') is-invalid @enderror" id="rolesName" placeholder="@lang('adminPanel.city-name-en')">
                                    @error('city_name_en')
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="city_name_ar" class="form-control  @error('city_name_ar') is-invalid @enderror" id="rolesName" placeholder="@lang('adminPanel.city-name-ar')">
                                    @error('city_name_ar')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
