<nav id="sidebar" class="sidebar-wrapper sidebar-dark">
        ...
        <ul class="sidebar-menu">
            ...
            <li class=" @if(Request::segment(2) == 'home') active @endif">
                <a href="{{route('store.home')}}">
                    <img src="{{asset('assets/images/icon-dashboard.svg')}}" width='20' class='me-3' alt="">
                    @lang('adminPanel.home')
                </a>
            </li>
            @if(auth()->user()->can('products-show') || auth()->user()->can('products-create'))
            <li class="sidebar-dropdown @if(Request::segment(1) == 'products') active @endif">
                <a href="javascript:void(0)">
                    <img src="{{asset('assets/images/icon/icon-product.svg')}}" width='20' class='me-3' alt="">
            ...
            <li class=" @if(Request::segment(2) == 'sales') active @endif">
                <a href="{{route('store.sales.index')}}">
                    <img src="{{asset('assets/images/icon/icon-sale.svg')}}" width='20' class='me-3' alt="">
            ...
            <li class=" @if(Request::segment(2) == 'orders') active @endif">
                <a href="{{route('store.orders.index')}}">
                    <img src="{{asset('assets/images/icon/icon-3d-design.svg')}}" width='20' class='me-3' alt="">
            ...
            <li class=" @if(Request::segment(2) == 'customers') active @endif">
                <a href="{{route('store.customers.index')}}">
                    <img src="{{asset('assets/images/icon/icon-clients.svg')}}" width='20' class='me-3' alt="">
                    @lang('adminPanel.customers')
                </a>
            </li>
            @endif
            @if(auth()->user()->can('affiliates-show') || auth()->user()->can('affiliates-create'))
            <li class="sidebar-dropdown  @if(Request::segment(1) == 'affiliate') active @endif">
                <a href="javascript:void(0)">
                    <img src="{{asset('assets/images/icon/icon-marketing.svg')}}" width='20' class='me-3' alt="">
            ...
            <li class=" @if(Request::segment(2) == 'copons') active @endif">
                <a href="{{route('store.copons.index')}}">
                    <img src="{{asset('assets/images/icon/icon-coupon.svg')}}" width='18' class='me-3' alt="">
            ...
            <li class=" @if(Request::segment(2) == 'return') active @endif">
                <a href="{{route('store.return.index')}}">
                    <img src="{{asset('assets/images/icon/icon-returns.svg')}}" width='18' class='me-3' alt="">
 ...
 <li class=" @if(Request::segment(2) == 'packages') active @endif">
                <a href="packages.php">
                    <img src="{{asset('assets/images/icon/icon-packages.svg')}}" width='18' class='me-3' alt="">
...
@if(auth()->user()->can('store-basic-settings-edit')|| auth()->user()->can('store-seo-edit')||
auth()->user()->can('store-default-currency-edit')|| auth()->user()->can('store-employees-show')||
auth()->user()->can('store-employees-create')|| auth()->user()->can('store-employees-edit')|| 
auth()->user()->can('store-employees-delete')||
auth()->user()->can('store-advertisments-show')||auth()->user()->can('store-advertisments-create')||
...
auth()->user()->can('store-advertisments-delete'))
            ...
            <li class=" @if(Request::segment(2) == 'stores') active @endif">
                <a href="{{route('admin.stores.index')}}">
                    <img src="{{asset('assets/images/icon-user.svg')}}" width="20" class="me-3" alt="">
            ...
            @if(auth()->user()->can('admin-products-show') || auth()->user()->can('admin-products-create'))
            ...
            @endif
             @if(auth()->user()->can('admin-products-create'))
                        <li><a href="{{route('admin.products.add.ready_made')}}"> @lang('adminPanel.add-ready-made') </a></li>
                        <li><a href="{{route('admin.products.add.custom_made')}}"> @lang('adminPanel.add-custom-made') </a></li>
                        <li><a href="{{ route('admin.products.add.service_made') }}"> @lang('adminPanel.add-service-made') </a></li>
            ...
            @if(auth()->user()->can('admin-affiliates-show') || auth()->user()->can('admin-affiliates-create'))
            <li class="sidebar-dropdown  @if(Request::segment(1) == 'affiliate') active @endif">
                <a href="javascript:void(0)">
                    <img src="{{asset('assets/images/icon/icon-marketing.svg')}}" width='20' class='me-3' alt="">
                    @lang('adminPanel.marketing')
            ...
            @if(auth()->user()->can('admin-affiliates-create'))
                        <li><a href="{{route('admin.affiliate.add_affiliate')}}"> @lang('adminPanel.add-new-affiliate') </a></li>
            ...
            <li class=" @if(Request::segment(2) == 'profits') active @endif">
                <a href="{{route('admin.profits.index')}}">
                    <img src="{{asset('assets/images/icon/icon-clients.svg')}}" width='18' class='me-3' alt="">
            ...
            @if(auth()->user()->can('admin-abandoned-carts-show') || auth()->user()->can('admin-abandoned-carts-settings-edit'))
            ...
            <li class="sidebar-dropdown  @if(Request::segment(2) == 'abandoned-carts') show @endif">
                ...
                <div class="sidebar-submenu  @if(Request::segment(2) == 'abandoned-carts') d-block @endif">
                    ...
                    @if(auth()->user()->can('admin-abandoned-carts-show'))
                        <li  class="@if(Request::segment(2) == 'abandoned-carts' && Request::segment(3) == '') active  @endif"><a href="{{route('admin.abandoned-carts.index')}}"> @lang('adminPanel.all') </a></li>
                        
            @endif
            @if(auth()->user()->can('admin-abandoned-carts-settings-edit'))
                        <li  class="@if(Request::segment(2) == 'abandoned-carts' && Request::segment(3) == 'settings') active  @endif"><a href="{{route('admin.abandoned-carts.settings')}}"> @lang('adminPanel.abandoned-carts-settings') </a></li>
            ...
            @if(auth()->user()->can('basic-settings-edit')|| auth()->user()->can('social-media-settings-edit')|| auth()->user()->can('faq-edit')||
auth()->user()->can('about-us-edit')|| auth()->user()->can('privacy-edit')|| auth()->user()->can('default-package-edit')||
auth()->user()->can('package-settings-edit')|| auth()->user()->can('default-currency-edit')|| auth()->user()->can('currencies-show')||
...
auth()->user()->can('countries-delete')|| auth()->user()->can('cities-show')|| auth()->user()->can('cities-create')|| 
auth()->user()->can('cities-edit')|| auth()->user()->can('cities-delete')|| auth()->user()->can('admins-show')||
auth()->user()->can('admins-create')|| auth()->user()->can('admins-edit')|| auth()->user()->can('admins-delete')||
auth()->user()->can('advertisments-show')||auth()->user()->can('advertisments-create')|| auth()->user()->can('advertisments-edit')|| 
auth()->user()->can('advertisments-delete') ||auth()->user()->can('payments-type-show') )
