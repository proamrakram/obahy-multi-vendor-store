/* 
   Template Name: Obayh
   Author: Akwade Co.
   Website: https://akwade.com/
   Mail: info@akwade.com
   Version: 1.0.0
   Updated: March 2022
...
if(document.getElementById("select-all")){
    document.getElementById('select-all').onclick = function() {
        var checkboxes = document.querySelectorAll('input[data-check-all="yes"]');
...
window.addEventListener('load', function() {
    document.querySelector('input[uploade="file"]').addEventListener('change', function() {
        if (this.files && this.files[0]) {
            var img = document.getElementById('uplodeImage');
            img.onload = () => {
...
function toggleBulr() {
    // document.getElementById("btnMenuUser").addEventListener("click", function() {
    //     document.getElementsByClassName("layout-specing")[0].classList.toggle("overflow");
    //     document.getElementsByClassName("page-content")[0].classList.toggle("overflow");
    // });
